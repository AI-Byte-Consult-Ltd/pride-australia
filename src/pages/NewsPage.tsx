...
const NewsPage = () => {
  ...
  return (
    <>
      <PageSEO
        title="News | Pride Social Network"
        description="Stay informed about LGBTQIA+ news, events, and community updates across the European Union — culture, pride events, rights, and safety."
        path="/news"
      />
